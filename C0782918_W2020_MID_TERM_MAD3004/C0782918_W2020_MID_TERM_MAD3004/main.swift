...
var bill01 = Internet(billId: 1, billDate: Date.from(year: 2020, month: 02, day: 14) ?? Date() , billType: Enum.type.INTERNET, totalBillAmount: 50.0, providerName: "Fido", internetGBUsed: 15)
var bill02 = Mobile(billId: 2, billDate: Date.from(year: 2019, month: 06, day: 04) ?? Date(), billType: Enum.type.MOBILE, totalBillAmount: 65.0, mobileManufacturerName: "Samsung", planName: "Internet + Talk", mobileNumber: "9842677168", internetGBUsed: 20, minuteUsed: 40)
var bill03 = Hydro(billId: 3, billDate: Date.from(year: 2020, month: 01, day: 01) ?? Date(), billType: Enum.type.HYDRO, totalBillAmount: 120, agencyName: "Electricity Services", unitConsumed: 150)
var bill04 = Internet(billId: 4, billDate: Date.from(year: 2019, month: 12, day: 05) ?? Date(), billType: Enum.type.INTERNET, totalBillAmount: 300, providerName: "Lucky", internetGBUsed: 55)
