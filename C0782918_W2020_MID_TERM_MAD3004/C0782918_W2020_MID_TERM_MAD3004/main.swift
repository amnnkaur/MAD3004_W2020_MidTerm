...
var bill02 = Mobile(billId: 2, billDate: Date.from(year: 2020, month: 02, day: 14) ?? Date(), billType: Enum.type.MOBILE, totalBillAmount: 65.0, mobileManufacturerName: "Samsung Inc.", planName: "Internet + Talk", mobileNumber: 9842677168, internetGBUsed: 45, minuteUsed: 15)
var bill03 = Hydro(billId: 3, billDate: Date.from(year: 2020, month: 02, day: 14) ?? Date(), billType: Enum.type.HYDRO, totalBillAmount: 120, agencyName: "Ontario electricity Services Inc.", unitConsumed: 150)
